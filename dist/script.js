...
var changeModalState = function changeModalState(state) {
        ...
        switch (item.nodeName) {
          ...
          case 'INPUT':
            if (item.getAttribute('type') === 'checkbox') {
              i === 0 ? state[prop] = 'Холодное остекление' : state[prop] = 'Теплое остекление';
  ...
  bindActionToElems('change', windowProfile, 'profile'); //переделать

  var triggerBtn = document.querySelector('[data-timeout]'),
